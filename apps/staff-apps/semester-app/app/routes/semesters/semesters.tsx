    ...
    <>
      ...
      >
        {semesters.map((semester) => (
          <li key={semester.id} className="relative flex justify-between gap-x-6 px-4 py-5 hover:bg-gray-50 sm:px-6">
            <div className="flex min-w-0 gap-x-4">

              <PackageOpenIcon aria-hidden="true" className="h-5 w-5 flex-none text-gray-400" />
